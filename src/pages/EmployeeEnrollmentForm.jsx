  ...
  ({
    ...
    const validateForm3 = () => {
      ...
      if (formData.jobExperience == "Yes" && !formData.jobExperienceInMonths) {
        newErrors.jobExperienceInMonths =
          "Job experience in Months is required";
      }
      return newErrors;
    };
    const validateForm4 = () => {
    ...
    const validateForm7 = () => {
      ...
      if (
        ...
        newErrors.doctorName =
          "Doctor name is required for booster vaccination";
      }
    ...
    const validateForm8 = () => {
      ...
      if (formData.employmentHours === "Part Time" && !formData.hourlyRate) {
        newErrors.hourlyRate =
          "Hourly Rate is required for Part-Time employment";
      }
          ...
          <Card
            ...
            style={
              paper
                ...
                : { margin: "0px", padding: "10px", borderRadius: "10px" }
            }
            className={
              paper
                ? "w-custom rounded-3 shadow border-0"
                : "w-100 rounded-3 shadow border-0"
            }
          >
              ...
              <div>
                ...
                <div>
                  ...
                  <Button
                    ...
                    onClick={handleSave}
                    className={
                      activeStep === steps.length - 1 && readOnly
                        ? "d-none"
                        : ""
                    }
                  >
...
const PersonalDetails = React.memo(
  ({ onFormChange, formData, setFormData, readOnly }) => {
    const [errors, setErrors] = useState({});

    const handleInputChange = (e) => {
      const { name, value } = e.target;
      if (name === "additionalPhoneNumber" && value.length > 10) {
        return;
      }
      ...
      <div>
        ...
        <FormControl fullWidth className="mb-2">
          ...
          <Select
            ...
            label="State"
          >
            <MenuItem key={"9991"} value={"Select State"}>
              {"Select State"}
            </MenuItem>
...
export default React.memo(EmployeeEnrollmentForm);
